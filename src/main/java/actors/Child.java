...
public class Child extends UntypedActor{
    ...
    public void onReceive(Object message) throws Exception {
        if(message instanceof Commands.ShotsCommand) {
            ...
            Info.fileWriter.write("\n" + System.currentTimeMillis() + " ==> " + " Inside onReceive of Child. SHOTS. Index = " + ((Commands.ShotsCommand) message).index + " Player Link = " + ((Commands.ShotsCommand) message).playerDetails.playerLink + " Player ID = " + ((Commands.ShotsCommand) message).playerDetails.FFT_player_id + " Team = " + ((Commands.ShotsCommand) message).playerDetails.team_name + " No. shots Complete = " + ((Commands.ShotsCommand) message).playerDetails.numShotsComplete + " Shots = " + ((Commands.ShotsCommand) message).shots.size() + "\n");
            ...
            Info.fileWriter.write("\n" + System.currentTimeMillis() + " ==> " + " Inside onReceive of Child. PENALTIES. " + "PlayerLink = " + ((Commands.Global) message).playerDetails.playerLink + " Player ID = " + ((Commands.Global) message).playerDetails.FFT_player_id + " Team = " + ((Commands.Global) message).playerDetails.team_name + " Penalties = " + ((Commands.PenaltiesCommand) message).penalties.size() + "\n");
            getSender().tell(message, getSelf());
        }
            ...
            Info.fileWriter.write("\n" + System.currentTimeMillis() + " ==> " + " Inside onReceive of Child. FKSHOTS. " + "PlayerLink = " + ((Commands.Global) message).playerDetails.playerLink + " Player ID = " + ((Commands.Global) message).playerDetails.FFT_player_id + " Team = " + ((Commands.Global) message).playerDetails.team_name + " FKShots = " + ((Commands.FreekickshotsCommand) message).freekickshots.size() + "\n");
            getSender().tell(message, getSelf());
        }
            ...
            Info.fileWriter.write("\n" + System.currentTimeMillis() + " ==> " + " Inside onReceive of Child. PASSES. Index = " + ((Commands.PassesCommand) message).index + "PlayerLink = " + ((Commands.Global) message).playerDetails.playerLink + " Player ID = " + ((Commands.Global) message).playerDetails.FFT_player_id + " Team = " + ((Commands.Global) message).playerDetails.team_name + " Passes = " + ((Commands.PassesCommand) message).passes.size() + "\n");
            getSender().tell(message, getSelf());
        }
            ...
            Info.fileWriter.write("\n" + System.currentTimeMillis() + " ==> " + " Inside onReceive of Child. ASSISTS. Index = " + ((Commands.AssistsCommand) message).index + "PlayerLink = " + ((Commands.Global) message).playerDetails.playerLink + " Player ID = " + ((Commands.Global) message).playerDetails.FFT_player_id + " Team = " + ((Commands.Global) message).playerDetails.team_name + " Assists = " + ((Commands.AssistsCommand) message).assists.size() + "\n");
            getSender().tell(message, getSelf());
        }
            ...
            Info.fileWriter.write("\n" + System.currentTimeMillis() + " ==> " + " Inside onReceive of Child. RECEIVEDPASSES." + "PlayerLink = " + ((Commands.Global) message).playerDetails.playerLink + " Player ID = " + ((Commands.Global) message).playerDetails.FFT_player_id + " Team = " + ((Commands.Global) message).playerDetails.team_name + " ReceivedPasses = " + ((Commands.ReceivedPassesCommand) message).receivedpasses.size() + "\n");
            getSender().tell(message, getSelf());
        }
